        ...
        <div className="bg-white p-10 md:p-14 rounded-[3.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.06)] border border-slate-50 relative group overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              {/* Email */}
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1 leading-none block">
                  Email
                </label>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 leading-none block">
                    Adgangskode
                  </label>
                  <button
                    type="button"
                    className="text-[9px] font-black uppercase tracking-widest text-[#cc5533] hover:underline"
                  >
                    Glemt koden?
                  </button>
                </div>
              ...
              {/* Fejl */}
              {loginError && (
                <p className="text-sm text-red-500 font-medium bg-red-50 rounded-2xl px-4 py-3">
                  {loginError}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-slate-900 text-white py-7 rounded-[2.5rem] font-black uppercase text-sm tracking-[0.2em] shadow-2xl hover:bg-[#cc5533] hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4 group/btn relative overflow-hidden leading-none disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
        ...
        <div className="mt-12 flex flex-col items-center space-y-6 text-center">
          <div className="flex items-center gap-10 opacity-40">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest">Sikkert Log-ind</span>
            </div>
