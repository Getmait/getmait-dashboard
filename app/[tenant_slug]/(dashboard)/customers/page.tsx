    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div className="flex gap-3">
          <div className="bg-orange-50 border border-orange-100 px-5 py-3 rounded-2xl text-center">
            ...
            <p className="text-xl font-black text-[#ea580c] leading-none">{smsRecipients.length}</p>
          </div>
          <div className="bg-slate-900 px-5 py-3 rounded-2xl text-center shadow-lg">
            ...
            <p className="text-xl font-black text-white leading-none">{totalSmsSent.toLocaleString('da-DK')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-[2.5rem] p-10 border border-slate-200 shadow-sm relative overflow-hidden">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-xl font-black uppercase tracking-tighter text-slate-800 leading-none">
                Send SMS Kampagne
              </h3>
            </div>
              ...
              <div className="bg-slate-50 rounded-[2rem] p-6 border border-slate-100 space-y-5 mb-6">
                ...
                {offerType !== 'fri' && (
                  <div>
                    ...
                    {offerType === 'savner' && (
                      <p className="text-[10px] font-bold text-orange-500 mt-2 ml-1 leading-none">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-between items-center">
              ...
              <button
                ...
                className="bg-slate-900 text-white px-10 py-5 rounded-[1.8rem] font-black text-xs uppercase tracking-[0.2em] hover:bg-[#ea580c] transition-all shadow-2xl flex items-center gap-4 group disabled:opacity-40"
              >
          ...
          <section className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4 bg-white">
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-xl font-black uppercase leading-none text-slate-800">
                  Dine Stamkunder
                </h3>
              </div>
              <div className="relative w-full md:w-72">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-6 py-3.5 text-[10px] font-black outline-none uppercase tracking-widest text-slate-900 shadow-inner leading-none"
                />
              </div>
            </div>
                  ...
                  {filtered.map((customer) => {
                    ...
                    return (
                      <tr key={customer.id} className="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td className="px-6 py-5 text-slate-500 font-bold text-sm leading-none">
                          {customer.phone}
                        </td>
                        <td className="px-6 py-5 text-slate-400 text-[11px] leading-none max-w-[180px] truncate">
                          {customer.address ?? <span className="text-slate-200">—</span>}
                        </td>
                        <td className="px-6 py-5 font-black text-slate-800 leading-none">
                          {customer.order_count}
                        </td>
                        <td className="px-8 py-5 text-right text-slate-400 font-bold uppercase text-[11px] leading-none">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-orange-400 mb-8 leading-none">
              Konvertering
            </h4>
            <div className="space-y-6 relative z-10">
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-[10px] font-bold uppercase text-slate-500 tracking-widest mt-2 leading-none">
          ...
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-200 shadow-sm relative group overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-[10px] font-black uppercase text-slate-400 leading-none">Stamkunder</span>
                <span className="text-sm font-black text-slate-800 leading-none">
                  {customers.filter((c) => getCustomerStatus(c.order_count, c.last_order_at) === 'Stamkunde').length}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[10px] font-black uppercase text-slate-400 leading-none">SMS-tilmeldte</span>
                <span className="text-sm font-black text-[#ea580c] leading-none">{smsRecipients.length}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[10px] font-black uppercase text-slate-400 leading-none">Kampagner sendt</span>
                <span className="text-sm font-black text-slate-800 leading-none">{campaigns.length}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-orange-50 rounded-[2.5rem] p-8 border border-orange-100 relative overflow-hidden group">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h4 className="text-[10px] font-black uppercase tracking-[0.3em] leading-none text-[#ea580c]">
                Mait AI Indsigt
              </h4>
            </div>
      ...
      <div className="bg-slate-900 rounded-[3rem] p-10 text-white flex items-center justify-between shadow-2xl relative overflow-hidden">
        <div className="relative z-10 flex items-center gap-8">
          ...
          <div>
            <h4 className="text-xl font-black uppercase tracking-tighter mb-2 text-orange-500 leading-none">
